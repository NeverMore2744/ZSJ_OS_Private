 ...
 */
struct slab_head {
    void *end_ptr;  // The final slab block pointer
    unsigned int nr_objs;  // The number of objects
};
...
struct kmem_cache_node {
    struct list_head partial;  // Not full pages
...
struct kmem_cache_cpu {
    ...
    struct page *page;  // points to the current page(struct)
};
